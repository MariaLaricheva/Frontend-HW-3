...
const ProductDetail = () => {
  ...
  /*
  const productDetail = React.useRef<null | ProductDetailStore>(null);
  if (productDetail.current === null) {
    productDetail = new ProductDetailStore();
  }
  const productDetailStore = productDetail.current;
   */
